  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-teal-950/60 p-4" role="presentation">
      <section
        ...
        className="relative max-h-[90vh] w-full max-w-lg overflow-hidden cartoon-section bg-white p-8"
        role="dialog"
      >
        ...
        <PawIcon size={40} className="absolute bottom-4 left-5 text-teal-800 opacity-15 pointer-events-none" style={{ transform: 'rotate(22deg)' }} />
        <div className="relative overflow-y-auto max-h-[calc(90vh-4rem)] pt-2 pr-2">
