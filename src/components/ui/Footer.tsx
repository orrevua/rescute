...
export function Footer() {
  return (
    <footer className="border-ink relative mt-auto border-t-3 bg-teal-950 px-6 py-8 text-stone-200 shadow-[0_-3px_0_var(--cartoon-ink)]">
      <div className="mx-auto flex max-w-6xl items-center justify-between">
        ...
        <Link
          className="cartoon-btn border-stone-300 bg-transparent px-5 py-1.5 text-stone-200 hover:bg-teal-800"
          href="/about"
        >
          About
        </Link>
