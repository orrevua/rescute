...
export function ActionCard({
  ...
  if (size === 'pill') {
    return (
      ...
      >
        <PawIcon
          className="absolute -right-5 -bottom-5 text-[#2d5a3e] opacity-40"
          size={80}
  ...
  return (
    <Link
      href={href}
      className="group relative block h-56 overflow-hidden rounded-3xl bg-[#1a3a38] shadow-[0_0_0_3px_#1a3a38,5px_5px_0_#1a3a38] transition-all duration-150 hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[0_0_0_3px_#1a3a38,7px_7px_0_#1a3a38]"
    >
      <Image
        src={image}
        alt=""
