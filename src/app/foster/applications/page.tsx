    ...
    <ProtectedRoute requiredRole="foster">
      <div className="px-6 py-10">
        <div className="mx-auto max-w-3xl">
          <h1 className="text-4xl font-bold text-stone-900">My applications</h1>
          <p className="mt-2 text-stone-600">Follow every step of your foster home journey.</p>
            ...
            {applications.map((application) => (
              <article key={application.id} className="rounded-2xl bg-white p-5 shadow-sm">
                <div className="flex items-start justify-between gap-3">
                  <div>
                    <h2 className="font-bold text-stone-900">Foster home application</h2>
          ...
          {!error && applications.length === 0 && (
            <p className="mt-6 rounded-2xl border border-dashed border-stone-300 p-6 text-stone-600">
