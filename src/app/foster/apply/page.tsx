    ...
    <ProtectedRoute requiredRole="foster">
      <div className="px-6 py-10">
        <div className="mx-auto max-w-2xl">
          <p className="text-sm font-bold tracking-[0.18em] text-teal-700">FOSTER HOME</p>
          <h1 className="mt-2 text-4xl font-bold text-stone-900">
            Make room for a story to begin again.
          </h1>
          <p className="mt-3 leading-7 text-stone-600">
            Your answers help us find safe and compatible foster placements.
          </p>
