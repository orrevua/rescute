    ...
    <div>
      ...
      <div className="relative z-10 mx-auto -mt-8 max-w-6xl px-6">
        <section className="flex flex-col gap-4 md:flex-row [&>*]:md:flex-1">
          ...
          <Link
            href="/cats"
            className="group relative flex h-20 items-center justify-center overflow-hidden rounded-2xl bg-amber-400 text-lg font-black text-stone-950 shadow-[0_0_0_3px_#1a3a38,4px_4px_0_#1a3a38] transition-all duration-200 hover:translate-x-[-2px] hover:translate-y-[-2px] hover:bg-amber-300 hover:shadow-[0_0_0_3px_#1a3a38,6px_6px_0_#1a3a38]"
          >
            <PawIcon
              className="absolute -right-5 -bottom-5 text-amber-500 opacity-40"
              size={80}
        ...
        {/* About section */}
        <section className="cartoon-card relative mt-16 overflow-hidden bg-white p-10">
          <PawIcon
            size={56}
          ...
          <PawIcon
            size={40}
            className="pointer-events-none absolute bottom-4 left-6 text-teal-800 opacity-20"
            style={{ transform: 'rotate(25deg)' }}
          />
          <PawIcon
            size={32}
            className="pointer-events-none absolute top-1/2 right-1/4 text-teal-800 opacity-15"
          ...
          <div className="mt-5 grid gap-8 md:grid-cols-3">
            <div>
              ...
              <p className="mt-2 text-stone-600">
                Get to know each personality before choosing. Every cat has their own story waiting
            ...
            <div>
              ...
              <p className="mt-2 text-stone-600">
                Your space can be the bridge to a fresh start. Temporary shelter makes a permanent
                difference.
              </p>
            </div>
            <div>
              ...
              <p className="mt-2 text-stone-600">
                Donations keep the care going. Every contribution helps feed, heal, and shelter cats
                in need.
              </p>
            </div>
          </div>
        ...
        <section className="mt-12 mb-16 grid gap-6 md:grid-cols-2">
          <ActionCard href="/cats" label="Meet our cats" image="/Cat-on-couch.jpg" size="large" />
          <Link
            href="/partners"
          ...
          >
            <PawIcon
              className="absolute -right-6 -bottom-6 text-amber-500 opacity-40"
              size={120}
              style={{ transform: 'rotate(-45deg)' }}
            />
